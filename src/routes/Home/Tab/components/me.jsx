...
const Me = ({ id, active }) => (
  ...
  >
    <div className="home-wrapper-1">
      <div className="home-left">
        ...
        <span className="home-intro">
          I'm Abhishek Anand, a Full Stack Developer
          <img
    ...
    <div className="icon-wrapper">
      <a href="https://www.linkedin.com/in/abhishek1522/ " target="_blank" rel="noreferrer">
        <img
      ...
      <a href="https://github.com/AbhishekIT22112002" target="_blank" rel="noreferrer">
        <GitIcon />
      </a>
    </div>
  </motion.div>
